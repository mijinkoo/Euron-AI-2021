...
Original file is located at
    https://colab.research.google.com/drive/1ze-bjT5O7KvMjmWNglnNO2nQloJDvvDQ
"""
...
$\color{blue}{\textit Your Explanation:}$ svm은 safety margin을 통해 robustness를 제공해주므로 데이터가 변하게 되더라도 loss 값이 변하지 않는다. 반면에 softmax는 모든 인자들을 다 고려해서 데이터가 변하면 loss 값도 변한다.
