...
Original file is located at
    https://colab.research.google.com/drive/1jJVPBcZEmyOSmRPRuSTb6m1zY8wakGAM
"""
...
## Answer:
배치 정규화를 사용하면 신경망을 학습시킬 수 있는 가중치 초기화의 범위가 커진다. 가중치 초기화에 대해 덜 엄격하게 허용하여 배치 정규화를 이용하면 가중치 초깃값에 크게 의존하지 않아도 되는 장점이 있다.
...
## Answer:
배치 정규화를 이용할 경우 배치 크기가 클수록 결과가 더 좋은 것을 확인할 수 있다.
...
## Answer: 
2. feature의 크기가 작으면 layer normalization 성능에 영향을 준다. feature의 dimension이 작을수록 평균과 표준편차 값이 더 noisy해지고 성능의 결과도 좋지 않을 것이다.  
